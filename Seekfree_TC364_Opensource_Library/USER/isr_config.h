...
//------------PIT中断参数相关定义------------
#define CCU6_0_CH0_INT_SERVICE	IfxSrc_Tos_cpu1	//定义CCU6_0 PIT通道0中断服务类型，即中断是由谁响应处理 0:CPU0 2:CPU1 1:DMA  不可设置为其他值
...
//#define ERU_CH3_CH7_INT_PRIO    255  //定义ERU通道3和通道7中断优先级 同上

//------------DMA中断参数相关定义------------
#define	ERU_DMA_INT_SERVICE     IfxSrc_Tos_cpu0	//ERU触发DMA中断服务类型，即中断是由谁响应处理 0:CPU0 2:CPU1 1:DMA  不可设置为其他值
#define ERU_DMA_INT_PRIO        33  //ERU触发DMA中断优先级 优先级范围1-255 越大优先级越高 与平时使用的单片机不一样
//#define ERU_DMA_INT_PRIO        253  //ERU触发DMA中断优先级 优先级范围1-255 越大优先级越高 与平时使用的单片机不一样
