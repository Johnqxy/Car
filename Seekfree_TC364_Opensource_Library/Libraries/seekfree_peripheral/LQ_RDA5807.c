...
//  GPIO_KEY_Init();
  ...
  oled_p6x8str(1,4,txt );		//字符串显示

  //显示音量
  sprintf(txt,"Volm:%02d  ",Vol);
  oled_p6x8str(1,5,txt );		//字符串显示

  oled_p6x8str(3,1,"FM Radio" );//字符串显示
...
//		      {
//		        RDA5807_SetMute(1);
//		        oled_p6x8str(1,6,"Mute:Yes!" );		//字符串显示
//		        mute=0;
//		      }
//		      else
//		      {
//		        RDA5807_SetMute(0);
//		        oled_p6x8str(1,6,"Mute:No! " );		//字符串显示
//		        mute=1;
//		      }
//		      break;
//
