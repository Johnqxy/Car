...
IFX_ALIGN(4) uint8 image_cache[MT9V03X_H][MT9V03X_W];
uint8   receive[3];
uint8   receive_num = 0;
...
void mt9v03x_init(void)
{
    ...
    exposure_time_last = myCar.exposure_time;
    uart_receive_flag = 0;
...
uint16 Image_processing_time = 0;
//-------------------------------------------------------------------------------------------------------------------
...
{
    static uint32 Image_time1 = 0;
    static uint8 Image_timeflag = 0;
	...
	if(mt9v03x_dma_int_num >= link_list_num)
	{
        ...
        Img_type_test();
//        FlashHandle();
        error_x = PID_Loc(0,offset);
        if(!Image_timeflag)
        {
            Image_time1 = systick_getval_ms(STM0);
            Image_timeflag = 1;
        }
        else if(Image_timeflag)
        {
            Image_processing_time = (uint16)(systick_getval_ms(STM0) - Image_time1);
            Image_timeflag = 0;
        }
//        ips114_displayimage032(&image_cache[0][0], MT9V03X_W, MT9V03X_H);
//        Pixle_ADD_Midline();
//        seekfree_sendimg_03x( UART_2, Pixle[MT9V03X_H],  MT9V03X_W,  MT9V03X_H);
...
void oled_printf_MT9V03X(void)
{
    ips114_showstr(0,1,"EXP_TIME");
    ips114_showint32(100,1,GET_CFG[1][1],3);
    ips114_showstr(0,2,"GAIN");
    ips114_showint32(100,2,GET_CFG[7][1],3);
    ips114_showstr(0,3,"FPS");
    ips114_showint32(100,3,GET_CFG[2][1],3);
//    ips114_showstr(0,4,"OV7725_COL");
//    ips114_showint32(100,4,GET_CFG[3][1],3);
//    ips114_showstr(0,5,"OV7725_ROW");
//    ips114_showint32(100,5,GET_CFG[4][1],3);
}
