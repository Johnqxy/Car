...
#define IPS114_SCL_PIN          SPI1_SCLK_P10_2   //定义SPI_SCK引脚
#define IPS114_SDA_PIN          SPI1_MOSI_P10_3   //定义SPI_MOSI引脚
#define IPS114_SDA_IN_PIN       SPI1_MISO_P11_3   //定义SPI_MISO引脚  IPS没有MISO引脚，但是这里任然需要定义，在spi的初始化时需要使用
#define IPS114_CS_PIN           SPI1_CS4_P11_11    //定义SPI_CS引脚
     
#define IPS114_BL_PIN           P15_4	          //液晶背光引脚定义 由于实际通讯未使用P15_4因此 这里复用为GPIO
#define IPS114_REST_PIN         P10_1             //液晶复位引脚定义
