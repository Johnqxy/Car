...
#define FMSDA_OUT        gpio_dir(SOFT_FMI2C_SDA_PIN, GPO,PUSHPULL)
#define FMSDA_IN         gpio_dir(SOFT_FMI2C_SDA_PIN, GPI,PULLUP)

#define FMI2C_SCL_INIT   gpio_init(SOFT_FMI2C_SCL_PIN, GPO, 1,PUSHPULL)
#define FMI2C_SDA_INIT   gpio_init(SOFT_FMI2C_SDA_PIN, GPO, 1,PUSHPULL)

#define FMI2C_SCL_H      gpio_set(SOFT_FMI2C_SCL_PIN, 1)
#define FMI2C_SCL_L      gpio_set(SOFT_FMI2C_SCL_PIN, 0)

#define FMI2C_SDA_H      gpio_set(SOFT_FMI2C_SDA_PIN, 1)
#define FMI2C_SDA_L      gpio_set(SOFT_FMI2C_SDA_PIN, 0)

#define FMI2C_SDA_READ   gpio_get(SOFT_FMI2C_SDA_PIN)
